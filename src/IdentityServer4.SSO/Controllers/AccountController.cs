...
using IdentityServer4.SSO.Models.Account;
...
namespace IdentityServer4.SSO.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback()
        {
            ...
            var principal = await _users.CreateUserPrincipalAsync(s);
        ...
        private async Task<(UserViewModel user, string provider, string providerUserId, IEnumerable<Claim> claims)> FindUserFromExternalProviderAsync(AuthenticateResult result)
        {
            ...
            // find external user
            var user = await _users.FindByProviderAsync(provider, providerUserId);
